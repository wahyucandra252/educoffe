...
$nik = $_SESSION['nik'];
$query = "SELECT * FROM pengaduan WHERE nik='$nik' AND status='ditolak' ORDER BY tanggal_pengaduan DESC";
					...
					<table id="dataTable" class="table table-hover">
						...
						<tbody>
							...
							<tr>
								...
								<td><button class="btn btn-danger"><?php echo $row['status']; ?></button></td>
								<td>
